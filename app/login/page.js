    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)", marginBottom: 24, lineHeight: 1.6 }}>
          Sign in with your company Google account to track HDFC corporate card expenses.
        </p>
        ...
        <p style={{ fontSize: 11, color: "var(--text-tertiary)", marginTop: 20, lineHeight: 1.5 }}>
          Gmail read access is used to fetch transaction alerts.
        </p>
      </div>
    </div>
  );
