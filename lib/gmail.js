...
export async function fetchHDFCEmails() {
  ...
  // Comprehensive search for all HDFC card activity, Amazon, and refunds
  const queries = [
    // HDFC transaction alerts (all types)
    `from:alerts@hdfcbank.net`,
    `from:noreply@hdfcbank.net`,
    `from:hdfcbank.net subject:transaction`,
    `from:hdfcbank.net subject:refund`,
    `from:hdfcbank.net subject:reversal`,
    `from:hdfcbank.net subject:credit`,
    // Amazon orders and returns
    `from:auto-confirm@amazon.in`,
    `from:ship-confirm@amazon.in`,
    `from:order-update@amazon.in`,
    `from:returns@amazon.in`,
    `from:amazon.in subject:refund`,
    `from:amazon.in subject:return`,
    `from:amazon.in subject:"Your order"`,
    // Swiggy/Zomato receipts
    `from:noreply@swiggy.in subject:order`,
    `from:noreply@zomato.com subject:order`,
  ];
