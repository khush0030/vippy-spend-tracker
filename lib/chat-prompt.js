...
export function systemPrompt({ today, cycle, cardLabel }) {
  ...
  return [
    ...
    "Two different things are 'pending': charges without a receipt (missing_receipts) and receipts the user sent that have not matched a charge yet (waiting_receipts). For a vague question like 'what is pending' or 'what is left', check both.",
