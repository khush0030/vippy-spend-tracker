...
// Write-once by default: a stored receipt is evidence and must never change.
// A rebuilt package replaces the one before it, so it passes upsert.
export async function put(path, body, { contentType, bucket = RECEIPTS_BUCKET, upsert = false } = {}) {
