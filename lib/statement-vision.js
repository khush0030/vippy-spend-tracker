...
const MODEL = process.env.STATEMENT_MODEL || "openai:gpt-5.6";
 ...
 * still gets read.
 */
const MODEL_FALLBACK = process.env.STATEMENT_MODEL_FALLBACK || "sarvam:digitise";
...
const RETRYABLE = /overloaded|rate.?limit|429|50[0234]|timeout|ECONNRESET|fetch failed|ECONNREFUSED|ETIMEDOUT|EAI_AGAIN/i;
