...
export async function chatJson({
  ...
  // OpenAI reasoning models spend reasoning tokens from the same budget as
  // the answer; "minimal" isn't accepted by every model, "low" is.
  if (provider === "openai" && !think) body.reasoning_effort = "low";
