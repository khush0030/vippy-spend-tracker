...
function periodParam() {
  return {
    type: "string",
    description: "this_cycle | last_cycle | this_month | last_month | YYYY-MM | a month name | last_N_days | today | yesterday | a range YYYY-MM-DD..YYYY-MM-DD (for one single day, repeat the same date on both sides, e.g. 2026-09-09..2026-09-09)",
  };
}
